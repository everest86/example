...
class ControllerAccountAffiliate extends Controller {
	...
	public function getForm() {
		...
		if (!$affiliate_info && $this->config->get('config_affiliate_id')) {
			...
			if ($information_info) {
				$data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information', 'information_id=' . $this->config->get('config_affiliate_id'), true), $information_info['title']);
			} else {
				$data['text_agree'] = '';
			}
		} else {
